...
class Hparams:
    ...
    parser.add_argument('--logdir', default="./output/log/1", help="log directory")
    parser.add_argument('--num_epochs', default=80, type=int)
    parser.add_argument('--evaldir', default="./output/eval/1", help="evaluation dir")
    ...
    parser.add_argument('--testdir', default="./output/test/1", help="test result dir")
