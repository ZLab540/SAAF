...
class XceptionNet(object):
	...
	def __init__(self, is_training=True,keep_prob=0.5,num_classes=100):
	...
	def conv2d(self,inputs,output_channel,kernel_size,stride=1):
		...
		#return tensorlayer.activation.leaky_relu(inputs, alpha=0.2, name='leaky_relu')
	...
	def residual_separableConv(self,inputs,num_channels):
		...
		for channel in num_channels:
			...
			#inputs = tensorlayer.activation.leaky_relu(inputs, alpha=0.2, name='leaky_relu')
	...
	def forward(self,inputs):
		...
		#out = tensorlayer.activation.leaky_relu(self.separable_conv2d(out,1536), alpha=0.2, name='leaky_relu')
		#out = tensorlayer.activation.leaky_relu(self.separable_conv2d(out,2048), alpha=0.2, name='leaky_relu')
