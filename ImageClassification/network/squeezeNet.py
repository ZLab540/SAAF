...
class SqueezeNet(object):
	...
	def __init__(self, net_config,is_training,keep_prob,mode='A',num_classes=100):
	...
	def Fiber_moduleB(self,inputs,out_channel):
		...
		#return tensorlayer.activation.leaky_relu(tf.add(resudial,out), alpha=0.2, name='leaky_relu')
